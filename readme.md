...
$this->crud->addField([
    ...
    'type' => 'new_field_name',
    'view_namespace' => 'lagdo.dbadmin-backpack-addon::fields',
]);
```
...
cp -i vendor/lagdo/dbadmin-backpack-addon/src/resources/views/fields/field_name.blade.php resources/views/vendor/backpack/crud/fields/field_name.blade.php
```
...
```bash
composer remove lagdo/dbadmin-backpack-addon
```

## Change log

Changes are documented here on Github. Please see the [Releases tab](https://github.com/lagdo/dbadmin-backpack-addon/releases).
...
This project was released under Apache, so you can install it on top of any Backpack & Laravel project. Please see the [license file](license.md) for more information. 
